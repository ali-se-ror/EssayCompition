...
class EssaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create essay" do
    assert_difference("Essay.count") do
      post essays_url, params: { essay: { body: @essay.body, length: @essay.length, points: @essay.points, title: @essay.title, user_id: @essay.user_id } }
    end
  ...
  test "should update essay" do
    patch essay_url(@essay), params: { essay: { body: @essay.body, length: @essay.length, points: @essay.points, title: @essay.title, user_id: @essay.user_id } }
